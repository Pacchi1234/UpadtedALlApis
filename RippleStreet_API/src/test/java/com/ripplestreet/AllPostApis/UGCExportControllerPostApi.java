...
public class UGCExportControllerPostApi extends postApiutilities {
	@Test(groups="activityugcreview")
	public void UGCAssetExport() throws IOException {
		Testcase = 51;
		...
		response = RestAssured.given().contentType(ContentType.JSON).body(PutBody).when()
				.post("/activityugcreview/v1/export/ugcAsset");
