...
public class StoreControllerPostApi extends postApiutilities{
	@Test(groups="common-service")
	public void FetchNearestStores() throws IOException {
		Testcase = 49;
		...
		response = RestAssured.given().contentType(ContentType.JSON).body(PutBody).when()
				.post("/common-service/v1/fetchNearestStores");
