...
public class AchivementProgramControllerPostApi extends postApiutilities{
	@Test(groups="benefits-platform")
	public void createAchivementPrograme() throws IOException {
		Testcase=32;
		...
		response = RestAssured.given().contentType(ContentType.JSON).body(PutBody).when()
				.post("/benefits-platform/v1/achievementProgram");
