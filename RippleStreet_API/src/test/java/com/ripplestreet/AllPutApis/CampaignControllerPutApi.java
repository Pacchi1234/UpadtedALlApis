...
public class CampaignControllerPutApi extends genricUtilities {
	@Test(priority=233,groups="event-campaign-manager")
	public void updateCampaign() throws IOException {
		Testcase=233;
		...
		response = RestAssured.given().contentType(ContentType.JSON).body(PutBody).when()
				.put("/event-campaign-manager/v1/campaign/"+campaignId);
