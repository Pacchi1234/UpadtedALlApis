...
public class LegalControllerPutrApi extends genricUtilities{
	@Test(priority=246,groups="event-campaign-manager")
	public void updateLegalDisclaimer() throws Throwable {
		Testcase=246;
		...
		response = RestAssured.given().contentType(ContentType.JSON).body(PutBody).when()
				.put("/event-campaign-manager/v1/event/"+eventId+"/updateLegal");
