...
public class DraftEventControllerPutApi extends genricUtilities {
	@Test(priority=239,groups="event-campaign-manager")
	public void updateDraftEvent() throws Throwable {
		Testcase = 239;
