...
public class MarketingGoalsPutApi extends genricUtilities{
	@Test(priority=247,groups="event-campaign-manager")
	public void updateMArketingGoalForEvent() throws Throwable {
		Testcase=247;
		...
		response = RestAssured.given().contentType(ContentType.JSON).body(PutBody).when()
				.put("/event-campaign-manager/v1/event/"+eventId+"/marketingGoal/"+goalId);
