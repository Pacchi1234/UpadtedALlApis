...
public class CommunityControllerGetApi extends genricUtilities {
	...
	public void getUserProfile() {
		response = RestAssured.given().when().get("/community-service/community/userProfile/" + pid);
		Testcase = 30;
	...
	public void getUserDetails() {
		response = RestAssured.given().when().get("/community-service/community/users/" + eventId + "?eventInfo=true");
		Testcase = 31;
